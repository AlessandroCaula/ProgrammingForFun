...
namespace L_SystemControl
{
    public class GeometricInterpretation
    {
        ...
        //public Tuple<float, float> FTransformer(Tuple<float, float> oldCoords, Tuple<float, float> newTempCoords, bool isIncreasingOnXPositive, bool isIncreasingOnXNegative, bool isIncreasingOnYPositive, bool isIncreasingOnYNegative)
        //{
        //    if (newTempCoords != null)
        //    {
        //        return newTempCoords;
        //    }
        ...
        //    //else if (isIncreasingOnXPositive && !isIncreasingOnXNegative && isIncreasingOnYPositive && !isIncreasingOnYNegative)
        //    //{
        //    //    newCoords = MinusTransformer(oldCoords, null, true, false, false, false);
        //    //}
        //    //else if (isIncreasingOnXPositive && !isIncreasingOnXNegative && !isIncreasingOnYPositive && isIncreasingOnYNegative)
        //    //{
        //    //    newCoords = PlusTransformer(oldCoords, null, true, false, false, false);
        //    //}
        //    //else if (!isIncreasingOnXPositive && isIncreasingOnXNegative && !isIncreasingOnYPositive && isIncreasingOnYNegative)
        //    //{
        //    //    newCoords = MinusTransformer(oldCoords, null, false, true, false, false);
        //    //}
        //    //else if (!isIncreasingOnXPositive && isIncreasingOnXNegative && isIncreasingOnYPositive && !isIncreasingOnYNegative)
        //    //{
        //    //    newCoords = MinusTransformer(oldCoords, null, true, false, false, false);
        ...
        //    //if (newTempCoords == null)
        //    //{
        //    //    newTempCoords = MoveForward(oldCoords, newTempCoords, isIncreasingOnXPositive, isIncreasingOnXNegative, isIncreasingOnYPositive, isIncreasingOnYNegative);
        //    //    //newTempCoords = FTransformer(oldCoords, newTempCoords, isIncreasingOnXPositive, isIncreasingOnXNegative, isIncreasingOnYPositive, isIncreasingOnYNegative);
        //    //}
        ...
        //public Tuple<float, float> MinusTransformer(Tuple<float, float> oldCoords, bool isIncreasingOnXPositive, bool isIncreasingOnXNegative, bool isIncreasingOnYPositive, bool isIncreasingOnYNegative)
        //{
        //    //Turn Right by turning angle

        //    // Computing the angle in degree
        //    double rotationAngleGrad = this.rotationAngle * (Math.PI / 180.0);

        //    var res = -(int)Math.Sin(rotationAngleGrad);

        //    // Moving forward
        //    Tuple<float, float> newTempCoords = FTransformer(oldCoords, isIncreasingOnXPositive, isIncreasingOnXNegative, isIncreasingOnYPositive, isIncreasingOnYNegative);

        //    // Changing direction anticlockwise
        //    double newX = ((newTempCoords.Item1 - oldCoords.Item1) * (int)Math.Cos(rotationAngleGrad)) - ((newTempCoords.Item2 - oldCoords.Item2) * (int)Math.Sin(rotationAngleGrad)) + oldCoords.Item1;
        //    double newY = ((newTempCoords.Item1 - oldCoords.Item1) * (int)Math.Sin(rotationAngleGrad)) + ((newTempCoords.Item2 - oldCoords.Item2) * (int)Math.Cos(rotationAngleGrad)) + oldCoords.Item2;
