...
namespace L_SystemControl
{
    public partial class Form1 : Form
    {
        ...
        TextEdit textEditAxiom;
        TextEdit textEditFunction;
        TextEdit textEditCharacter;
        TextEdit textEditIterations;
        TextEdit textEditAngle;
        TextEdit textEditLength;
        SimpleButton simpleFakeButton;
        ...
        private void InitializePanelsAndTools()
        {
            ...
            this.textEditAxiom = new TextEdit();
            PanelControl panelCharAndFuncContainer = new PanelControl();
            this.textEditFunction = new TextEdit();
            this.textEditCharacter = new TextEdit();
            SimpleButton buttonUploadFunctions = new SimpleButton();
            SimpleButton buttonEmptyDictionary = new SimpleButton();
            PanelControl panelAngleIterLengthContainer = new PanelControl();
            this.textEditAngle = new TextEdit();
            this.textEditIterations = new TextEdit();
            this.textEditLength = new TextEdit();
            this.simpleFakeButton = new SimpleButton();

            panelCharAndFuncContainer.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.NoBorder;
            panelAngleIterLengthContainer.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.NoBorder;
