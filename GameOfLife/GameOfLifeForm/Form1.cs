...
namespace GameOfLife
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Method used for extracting the matrix selected with the Ctrl for the Copy Paste action. 
        /// </summary>
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            //// Check if the dimension of the form have been increased or decreased, consequently call the DecreaseCellSizeMatrixDimension or IncreaseCellSizeMatrixDimension.
            //// Retrieve the new dimension of the form window.
            //int newFormWidth = this.Size.Width;
            //int newFromHeight = this.Size.Height;
            //// Compare it with the old Form dimension. 
            //if (newFormWidth)
